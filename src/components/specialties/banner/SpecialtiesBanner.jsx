...
export default function SpecialtiesBanner() {
  return (
    <AnimatedComponent duration={1.4} delay={1} className="banner-spec-container">
      <AnimatedComponent duration={1.6} delay={2} x={-500} xExit={-500} className="text-banner-spec">
      ...
      <AnimatedComponent duration={1.6} delay={2} x={500} xExit={500} className="image-specs">  
